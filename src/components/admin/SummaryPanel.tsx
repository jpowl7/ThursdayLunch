          ...
          <div>
            <div className="flex items-baseline gap-2 mb-2">
              ...
              <p className="text-xs text-orange-400">
                <span className="material-symbols-outlined text-[10px] align-middle text-orange-400">thumb_up</span> = 1pt &middot; <span className="material-symbols-outlined text-[10px] align-middle text-yellow-500">star</span> = +1 bonus
              </p>
            </div>
